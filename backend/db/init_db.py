...
cursor.execute("CREATE TABLE IF NOT EXISTS object_positions (id INTEGER PRIMARY KEY AUTOINCREMENT, object_id INTEGER NOT NULL, location INTEGER, x REAL NOT NULL, y REAL NOT NULL, time REAL NOT NULL);")
cursor.execute("""INSERT INTO system_config (ai_running) VALUES (0);""")
sqlconn.commit()
sqlconn.close()
